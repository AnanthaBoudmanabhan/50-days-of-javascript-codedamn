...
const spaceAge = (seconds) => {
    ...
    const oneEarthYear = 31557600 //seconds

    const ageInEarth = seconds / oneEarthYear;

    // Your solution starts here
    for (let planet in yearsInAllPlanets) {
        yearsInAllPlanets[planet] = +(ageInEarth / orbitalPeriods[planet]).toFixed(2);
    }
